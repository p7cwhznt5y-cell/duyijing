console.log('🚨🚨🚨 我被调用了！接收到的请求体是：', request.body);
...
export async function onRequestPost(context) {
  ...
  console.log('✅ API Key 存在，长度:', env.DEEPSEEK_API_KEY.length);
  ...
  try {
    ...
    console.log('🚀 调用 DeepSeek API，模型: deepseek-v4-flash');
    ...
    const response = await fetch('https://api.deepseek.com/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'deepseek-v4-flash',  // ⭐ 关键修复：新模型名
