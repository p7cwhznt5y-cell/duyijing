// 注意：本文件经文数据为人工从《周易》原典录入，请勿用 AI 重新生成经文内容。
// 安全红线：AI 仅做交互和解读润色，不负责生成经文事实。
// 当前已录入 64 卦全集（周易 1-64 卦）。

import type { Hexagram, HexagramCategory } from "./types.ts";
...
export function getHexagramsByCategory(
